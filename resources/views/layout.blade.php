...
<head>
    ...
    <style>
        body {
            background-color: #f0f8ff; /* Couleur douce et agréable */
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('welcome') }}">
            <div class="sidebar-brand-icon rotate-n-15">
                <img src="{{asset('assets/img/DoucSoft_F_W.png')}}" alt="" width="30px">
            </div>
            <div class="sidebar-brand-text mx-3 rotate-n-14">Stock <sup>Management</sup></div>
        </a>
        ...
        <div class="sidebar-heading">Point de vente</div>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('Admin.responsable.index')}}">Nos responsables</a>
